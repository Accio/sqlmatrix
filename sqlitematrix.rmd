...
Benchmark for the speed of writing the matrix, reading the complete matrix, reading one cell of the matrix, reading one column of the matrix and reading one row of the matrix to and from sqlite in the serialisation approach. (repeated a 100 times)
...
Benchmark for the speed of writing the matrix, reading the complete matrix, reading one cell of the matrix, reading one column of the matrix and reading one row of the matrix to and from sqlite in the table approach. (repeated a 100 times)
